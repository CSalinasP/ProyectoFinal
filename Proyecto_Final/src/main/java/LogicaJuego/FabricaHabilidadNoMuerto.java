...
/**
 * Clase que usa el patrón Factory para fabricar las habilidades del No Muerto.
 * Crea 3 habilidades, una que solo hace daño, una que solo cura, y una que hace daño y cura a la vez.
 * @author CSalinasP
 * @version 1.2
 * @since 2025-07-10
 */
public class FabricaHabilidadNoMuerto{
    /** El daño base de la habilidad que solo hace daño. */
    static int damageBase1 = 30;
    /** El daño base de la habilidad que hace daño y cura a la vez. */
    static int damageBase2 = 10;
    /** La curación base de la habilidad que solo cura. */
    static int curacionBase1 = 20;
    /** La curación base de la habilidad que hace daño y cura a la vez. */
    static int curacionBase2 = 5;

    FabricaHabilidadNoMuerto(){}

    /**
     * Metodo que crea las 3 habilidades del No Muerto con los atributos base y los retorna.
     * Los atributos de la habilidad aumentan conforme el nivel del personaje es mayor.
     * @param Nivel El nivel del No Muerto al que se le están creando las habilidades.
     */
    ...
    public String toString(){
        return "Clase encargada de fabricar las habilidades del No Muerto.";
    }
}
