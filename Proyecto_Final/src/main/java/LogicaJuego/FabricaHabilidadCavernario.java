...
/**
 * Clase que usa el patrón Factory para fabricar las habilidades del Cavernario.
 * Crea 3 habilidades, una que solo hace daño, una que solo cura, y una que hace daño y cura a la vez.
 * @author CSalinasP
 * @version 1.2
 * @since 2025-07-10
 */
public class FabricaHabilidadCavernario {
    ...
    FabricaHabilidadCavernario(){}

    /**
     * Metodo que crea las 3 habilidades del Cavernario con los atributos base y los retorna.
     * Los atributos de la habilidad aumentan conforme el nivel del personaje es mayor.
     * @param Nivel El nivel del Cavernario al que se le están creando las habilidades.
     */
    ...
    public String toString(){
        return "Clase encargada de fabricar las habilidades del Cavernario.";
    }
}
