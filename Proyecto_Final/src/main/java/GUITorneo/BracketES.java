...
public class BracketES extends BracketTorneo {
    ...
    public BracketES (){
        torneo = EliminatoriaSimple.getInstance();
    ...
    public void dibujarBracket(Graphics2D g2d, Stroke solidStroke, ArrayList<Inscribible> enfrentamientos, int x, int y, int ronda){
    ...
    protected void paintComponent(Graphics g) {
        ...
        dibujarBracket(g2d, solidStroke, enfrentamientos, ANCHO_COMPETIDOR/2, ALTO_COMPETIDOR, 1);
        dibujarBracket(g2d, solidStroke, torneo.getEnfrentamientos2(), 3 * ANCHO_COMPETIDOR, 2 * ALTO_COMPETIDOR, 2);
        dibujarBracket(g2d, solidStroke, torneo.getEnfrentamientos3(), (11* ANCHO_COMPETIDOR)/2, 4 * ALTO_COMPETIDOR, 3);
        dibujarBracket(g2d, solidStroke, torneo.getEnfrentamientos4(), 8 * ANCHO_COMPETIDOR, 8 * ALTO_COMPETIDOR, 4);
    }
    


    private void dibujarCompetidor(Graphics2D g2d, Inscribible inscribible, int x, int y) {
        ...
        int textWidth = fm.stringWidth(inscribible.getNombre());
        int textX = x + (ANCHO_COMPETIDOR - textWidth) / 2;
        int textY = y + (ALTO_COMPETIDOR - fm.getHeight()) / 2 + fm.getAscent();
        g2d.drawString(inscribible.getNombre(), textX, textY);
    }
